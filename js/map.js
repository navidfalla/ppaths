...
$(function(){
  ...
  $(document).on('click', '.set-dest-btn', function(){
      ...
      function drawPath (){
        ...
        var lineGraph = svgParent.append("path")
                                  .attr("class", "path")
                                  .attr("id" , function(d, i){
                                      return "line" + i;
                                    })
                                  .attr("d", lineFunction(Obj))
                                  .attr("stroke", "#191970")
                                  .attr("stroke-width", 3)
                                  .attr("fill", "none")
                                  //.attr("stroke-dasharray", "5, 5")
                                  .attr("marker-start", "url(#square)")
                                  .attr("marker-mid", "url(#square)")
